...
function RendererBody({ educationInfoBachelorDegree, educationInfoMastersDegree, experienceInfoTheoreticalPhysicistJob, experienceInfoExperimentalPhysicistJob, bachelorDegreeEducationInfo, mastersDegreeEducationInfo, theoreticalPhysicistJobExperienceInfo, experimentalPhysicistJobExperienceInfo, isDefaultDataUsed }) {
    return (
        <>
